...
fn test_tag_color_rgba() {
    // Verify colors are non-zero and have full alpha
    for color in TagColor::all() {
...
proptest! {
    ...
    /// **Feature: ui-enhancements, Property 41: Tag Persistence**
    /// **Validates: Requirements 21.7**
    ///
    /// *For any* tag applied to a file, after serialization and deserialization,
    /// the file SHALL still have that tag.
    #[test]
    ...
    /// **Feature: ui-enhancements, Property 41b: Multiple Tags Persistence**
    /// **Validates: Requirements 21.7**
    ///
    /// *For any* multiple tags applied to multiple files, after serialization
    /// and deserialization, all tag-file associations SHALL be preserved.
    #[test]
    ...
    /// **Feature: ui-enhancements, Property 41c: Tag Operations Consistency**
    /// **Validates: Requirements 21.1, 21.2, 21.6**
    ///
    /// *For any* sequence of tag operations (create, apply, remove, delete),
    /// the TagManager state SHALL remain consistent.
    #[test]
