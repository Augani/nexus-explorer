use crate::models::{DualPane, FileEntry, PaneSide, PaneState};
...
fn test_dual_pane_pane_access() {
    ...
    dual.pane_mut(PaneSide::Left)
        .navigate_to(PathBuf::from("/new-left"));
...
fn test_dual_pane_sync_panes() {
    let mut dual = DualPane::with_paths(PathBuf::from("/active"), PathBuf::from("/inactive"));
